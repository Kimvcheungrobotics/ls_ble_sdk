...
class DeviceAd(Advertisement):
    def __init__(self, index):
        Advertisement.__init__(self, index, "peripheral")
        self.add_local_name("Target Device")
...
class DataService(Service):
    ...
    def __init__(self, index):
        ...
        self.add_characteristic(DataChar(self))
        self.data = ''
...
class DataChar(Characteristic):
    ...
    def __init__(self, service):
        Characteristic.__init__(
            ...
            ["read", 'write'], service)
        self.add_descriptor(DataCharDesc(self))
    ...
    def WriteValue(self, value, options):
        ...
        print(f'New value: {val}', flush=True)


class DataCharDesc(Descriptor):
    IP_ADDRESS_SYSTEM_DESCRIPTOR_UUID = "0001"
    IP_ADDRESS_SYSTEM_DESCRIPTOR_VALUE = "Data Buffer"
...
ble_app.add_service(DataService(0))
ble_app.register()
